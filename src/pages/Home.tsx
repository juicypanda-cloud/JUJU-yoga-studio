...
export const Home: React.FC = () => {
  ...
  const featuredItems = {
    ...
    videos: {
      ...
      description:
        'Гэрээсээ эсвэл хаанаас ч хүссэн цагтаа иог, бясалгалын видео хичээлүүдийг үзээрэй. Бүх контентыг «Онлайн сан» хуудаснаас сонгоно уу.',
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16 mx-auto text-center">
            ...
            <motion.p
              ...
              className="text-lg text-brand-ink/60 font-light leading-relaxed"
            >
              Иогын хөтөлбөр, бясалгалын тэмдэглэл, цахим ном зэрэг бүтээгдэхүүнийг студиээр дамжуулан худалдан авах боломжтой. Өөрийн дадал, суралцалтаа дэвтэртээ үлдээгээрэй.
            </motion.p>
          </div>
