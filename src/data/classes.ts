...
export const classData: ClassType[] = [
  {
    ...
    time: '07:00, 18:30',
    duration: '75 мин',
    description: 'Хата иог нь бие махбодь болон сэтгэл санааг тэнцвэржүүлэх уламжлалт арга барил юм. Энэхүү хичээл нь амьсгалын дасгал (пранаяма), биеийн байрлал (асана) болон бясалгалыг хослуулдаг.',
    benefits: [
  ...
  },
  {
    ...
    time: '19:00',
    duration: '60 мин',
    description: 'Виньяса иог нь амьсгал болон хөдөлгөөнийг нэгэн хэмнэлд оруулж, урсгал хөдөлгөөнөөр хичээллэдэг динамик төрөл юм. Биеийн халаалт болон эрч хүчийг нэмэгдүүлэхэд тустай.',
    benefits: [
  ...
  },
  {
    ...
    time: '20:15',
    duration: '90 мин',
    description: 'Инь иог нь гүнзгий сунгалт болон тайвшралд анхаарлаа хандуулсан удаан хэмнэлтэй төрөл юм. Биеийн холбогч эдүүдэд нөлөөлж, дотоод амар амгаланг олоход тусалдаг.',
    benefits: [
      'Гүнзгий сунгалт',
